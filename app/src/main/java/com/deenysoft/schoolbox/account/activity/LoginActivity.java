...
import com.deenysoft.schoolbox.account.app.AppConfig;
...
public class LoginActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            ...
            Intent intent = new Intent(LoginActivity.this, AccessView.class);
    ...
    private void checkLogin(final String email, final String password) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(name, email, phone_no, location, uid, created_at);
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                Intent intent = new Intent(LoginActivity.this, AccessView.class);
                                startActivity(intent);
                                //startActivity(new Intent(LoginActivity.this, AccessView.class));
                                finish();
                            }
                        });
                        ...
                        Toast.makeText(getApplicationContext(),
                                "Can't Login", Toast.LENGTH_LONG).show();
                    }
        ...
        CosmosApplication.getInstance().addToRequestQueue(strReq, tag_string_req);
    }
