...
import com.deenysoft.schoolbox.dashboard.detail.adapter.TestDetailAdapter;
 ...
 */
public class TestActivityDetail extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor mCursor = mSQLiteDatabase.rawQuery("SELECT * FROM test_table ", null);
        ...
        ListView mListView = (ListView) findViewById(R.id.test_item_list);
        // Setup adapter using cursor from last step
        TestDetailAdapter mTestDetailAdapter = new TestDetailAdapter(this, mCursor);
        // Attach adapter containing cursor to the ListView
        mListView.setAdapter(mTestDetailAdapter);
        mTestDetailAdapter.changeCursor(mCursor);
        ...
        mFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(TestActivityDetail.this, UploadMainActivity.class));
            }
        });
    ...
    public static Intent getStartIntent(Context context, TestBoxItem mTestBoxItem) {
        Intent starter = new Intent(context, TestActivityDetail.class);
        starter.putExtra(TestBoxItem.TAG, mTestBoxItem.getTestID());
        return starter;
    }
