...
import com.deenysoft.schoolbox.dashboard.detail.adapter.AssignmentDetailAdapter;
 ...
 */
public class AssignmentActivityDetail extends BaseActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            Cursor mCursor = mSQLiteDatabase.rawQuery("SELECT * FROM assignment_table ", null);
            ...
            ListView mListView = (ListView) findViewById(R.id.assign_item_list);
            // Setup adapter using cursor from last step
            AssignmentDetailAdapter mAssignmentDetailAdapter = new AssignmentDetailAdapter(this, mCursor);
            // Attach adapter containing cursor to the ListView
            mListView.setAdapter(mAssignmentDetailAdapter);
            mAssignmentDetailAdapter.changeCursor(mCursor);
            ...
            mFloatingActionButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(AssignmentActivityDetail.this, UploadMainActivity.class));
                }
            });
        ...
        public static Intent getStartIntent(Context context, AssignmentBoxItem mAssignmentBoxItem) {
            Intent starter = new Intent(context, AssignmentActivityDetail.class);
            starter.putExtra(AssignmentBoxItem.TAG, mAssignmentBoxItem.getAssignmentID());
            return starter;
        }
