...
import com.deenysoft.schoolbox.dashboard.detail.adapter.QuizDetailAdapter;
 ...
 */
public class QuizActivityDetail extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor mCursor = mSQLiteDatabase.rawQuery("SELECT * FROM quiz_table ", null);
        ...
        ListView mListView = (ListView) findViewById(R.id.quiz_item_list);
        // Setup adapter using cursor from last step
        QuizDetailAdapter mQuizDetailAdapter = new QuizDetailAdapter(this, mCursor);
        // Attach adapter containing cursor to the ListView
        mListView.setAdapter(mQuizDetailAdapter);
        mQuizDetailAdapter.changeCursor(mCursor);

        mFloatingActionButton = (FloatingActionButton) findViewById(R.id.floatUploadButton);
        mFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(QuizActivityDetail.this, UploadMainActivity.class));
            }
        });
    ...
    public static Intent getStartIntent(Context context, QuizBoxItem mQuizBoxItem) {
        Intent starter = new Intent(context, QuizActivityDetail.class);
        starter.putExtra(QuizBoxItem.TAG, mQuizBoxItem.getQuizID());
        return starter;
    }
