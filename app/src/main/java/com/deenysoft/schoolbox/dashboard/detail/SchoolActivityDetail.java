...
import com.deenysoft.schoolbox.dashboard.detail.adapter.SchoolDetailAdapter;
 ...
 */
public class SchoolActivityDetail extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor mCursor = mSQLiteDatabase.rawQuery("SELECT * FROM school_table ", null);
        //Cursor mCursor = mSQLiteDatabase.rawQuery("SELECT * FROM school_table WHERE TRIM(school_cardno)=?"+mSchoolBoxDBManager.getSchoolCardNo().trim(), null); // What a crazy combination i got here!!
        // Find ListView to populate
        ListView mListView = (ListView) findViewById(R.id.school_item_list);
        // Setup adapter using cursor from last step
        SchoolDetailAdapter mSchoolDetailAdapter = new SchoolDetailAdapter(this, mCursor);
        // Attach adapter containing cursor to the ListView
        mListView.setAdapter(mSchoolDetailAdapter);
        mSchoolDetailAdapter.changeCursor(mCursor);
        ...
        mFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SchoolActivityDetail.this, UploadMainActivity.class));
            }
        });
    ...
    public static Intent getStartIntent(Context context, SchoolBoxItem mSchoolBoxItem) {
        Intent starter = new Intent(context, SchoolActivityDetail.class);
        starter.putExtra(SchoolBoxItem.TAG, mSchoolBoxItem.getSchoolCardNo());
        return starter;
    }
