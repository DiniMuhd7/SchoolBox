...
import com.deenysoft.schoolbox.dashboard.detail.adapter.ExamDetailAdapter;
 ...
 */
public class ExamActivityDetail extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor mCursor = mSQLiteDatabase.rawQuery("SELECT * FROM exam_table ", null);
        ...
        ListView mListView = (ListView) findViewById(R.id.exam_item_list);
        // Setup adapter using cursor from last step
        ExamDetailAdapter mExamDetailAdapter = new ExamDetailAdapter(this, mCursor);
        // Attach adapter containing cursor to the ListView
        mListView.setAdapter(mExamDetailAdapter);
        mExamDetailAdapter.changeCursor(mCursor);
        ...
        mFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ExamActivityDetail.this, UploadMainActivity.class));
            }
        });
    ...
    public static Intent getStartIntent(Context context, ExamBoxItem mExamBoxItem) {
        Intent starter = new Intent(context, ExamActivityDetail.class);
        starter.putExtra(ExamBoxItem.TAG, mExamBoxItem.getExamID());
        return starter;
    }
