...
import com.deenysoft.schoolbox.dashboard.detail.adapter.NoteDetailAdapter;
 ...
 */
public class NoteActivityDetail extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor mCursor = mSQLiteDatabase.rawQuery("SELECT * FROM note_table ", null);
        ...
        ListView mListView = (ListView) findViewById(R.id.note_item_list);
        // Setup adapter using cursor from last step
        NoteDetailAdapter mNoteDetailAdapter = new NoteDetailAdapter(this, mCursor);
        // Attach adapter containing cursor to the ListView
        mListView.setAdapter(mNoteDetailAdapter);
        mNoteDetailAdapter.changeCursor(mCursor);
        ...
        mFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(NoteActivityDetail.this, UploadMainActivity.class));
            }
        });
    ...
    public static Intent getStartIntent(Context context, NoteBoxItem mNoteBoxItem) {
        Intent starter = new Intent(context, NoteActivityDetail.class);
        starter.putExtra(NoteBoxItem.TAG, mNoteBoxItem.getNoteID());
        return starter;
    }
