...
import com.deenysoft.schoolbox.dashboard.detail.adapter.CourseDetailAdapter;
 ...
 */
public class CourseActivityDetail extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor mCursor = mSQLiteDatabase.rawQuery("SELECT * FROM course_table ", null);
        ...
        ListView mListView = (ListView) findViewById(R.id.course_item_list);
        // Setup adapter using cursor from last step
        CourseDetailAdapter mCourseDetailAdapter = new CourseDetailAdapter(this, mCursor);
        // Attach adapter containing cursor to the ListView
        mListView.setAdapter(mCourseDetailAdapter);
        mCourseDetailAdapter.changeCursor(mCursor);

        mFloatingActionButton = (FloatingActionButton) findViewById(R.id.floatUploadButton);
        mFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CourseActivityDetail.this, UploadMainActivity.class));
            }
        });
    ...
    public static Intent getStartIntent(Context context, CourseBoxItem mCourseBoxItem) {
        Intent starter = new Intent(context, CourseActivityDetail.class);
        starter.putExtra(CourseBoxItem.TAG, mCourseBoxItem.getCourseID());
        return starter;
    }
