...
package com.deenysoft.schoolbox.helper;

import android.content.Context;
import android.content.SharedPreferences;
import android.text.TextUtils;

import com.deenysoft.schoolbox.model.Avatar;
...
public class PreferencesHelper {
    ...
    /**
     * Writes a {@link com.google.samples.apps.schoolbox.model.Player} to preferences.
     *
     * @param context The Context which to obtain the SharedPreferences from.
     * @param player  The {@link com.google.samples.apps.schoolbox.model.Player} to write.
     */
    ...
    /**
     * Retrieves a {@link com.google.samples.apps.schoolbox.model.Player} from preferences.
     *
     * @param context The Context which to obtain the SharedPreferences from.
    ...
    public static Player getPlayer(Context context) {
        ...
        return new Player(firstName, avatar);
    }
     ...
     */
    public static boolean isInputDataValid(CharSequence firstName) {
